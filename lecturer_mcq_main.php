...
<div class="col-xl-7" id="question-content">
    ...
    <div class="bg d-flex mx-auto flex-column p-5 m-5 shadow p-3 mb-5" style="background-color: white; width: 90%; border-radius: 10px;">
        ...
        <p class="text-uppercase fw-bold main-color m-2" style="color: #aaa;">
            ...
            <div class="form-floating mb-3">
                <div style="width:100%;height:40px;" class="bg-light"></div>
                <!-- <input type="text" class="form-control is-invalid" id="floatingInput" name="mcq-option" placeholder="Option 2" pattern="[a-zA-Z0-9\s.^`~!@#$%\^&*()_+={}|[\]\\:';<>?,./\x22]*" required>
        ...
        <p class="text-uppercase fw-bold main-color m-2" style="color: #aaa;">
            ...
            <div class="form-floating mb-3">
                <div style="width:100%;height:40px;" class="bg-light"></div>
                <!-- <input type="text" class="form-control is-invalid" id="floatingInput" name="mcq-option" placeholder="Option 3" pattern="[a-zA-Z0-9\s.^`~!@#$%\^&*()_+={}|[\]\\:';<>?,./\x22]*" required>
        ...
        <p class="text-uppercase fw-bold main-color m-2" style="color: #aaa;">
            ...
            <div class="form-floating mb-3">
                <div style="width:100%;height:40px;" class="bg-light"></div>
                <!-- <input type="text" class="form-control is-invalid" id="floatingInput" name="mcq-option" placeholder="Option 4" pattern="[a-zA-Z0-9\s.^`~!@#$%\^&*()_+={}|[\]\\:';<>?,./\x22]*" required>
...
<script src="js/mingliangJS.js"></script>
    <script>
        function changeContent(id) {
            var path = "lecturer_mcq_filled_form.php?id=" +id;
