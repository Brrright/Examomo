      ...
      <section class="pt-4 pb-4">
        <div class="row">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3 ">
            ...
            <p>
              <a href="student_exam_list.php" class="text-decoration-none text-black">Exams</a>
            </p>
            <p>
              <a href="student_view_result.php" class="text-decoration-none text-black">Results</a>
            </p>
            <p>
              <a href="student_feedback_page.php" class="text-decoration-none text-black">Feedback</a>
            </p>
            <p>
              <a href="student_FAQ.php" class="text-decoration-none text-black">FAQ</a>
            </p>
          </div>
