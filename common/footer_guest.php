      ...
      <section class="pt-4 pb-4">
        <div class="row">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3 ">
            ...
            <p>
              <a ref="guest_registration_page.php" class="text-decoration-none text-black">Get Started</a>
            </p>
            <p>
              <a href="login_page.php?role=admin" class="text-decoration-none text-black">Admin login</a>
            </p>
            <p>
              <a href="login_page.php?role=lecturer" class="text-decoration-none text-black">Lecturer login</a>
            </p>
            <p>
              <a href="login_page.php?role=student" class="text-decoration-none text-black">Student login</a>
            </p>
          </div>
